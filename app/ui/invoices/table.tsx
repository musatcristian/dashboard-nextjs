...
interface IIvoicesTable {
  query: string;
  currentPage: number;
}

const generateInvoicesData: (list: InvoicesTable[]) => {
  ...
  const newInvoices: JSX.Element[] = [];
  const newTableData: JSX.Element[] = [];
    ...
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
          <div className="md:hidden">{invoices}</div>
